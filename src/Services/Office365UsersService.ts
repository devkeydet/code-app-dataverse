...
export class Office365UsersService {
   ...
   */
  public static async MyTrendingDocuments($filter?: string, extractSensitivityLabel?: string, fetchSensitivityLabelMetadata?: string): Promise<IOperationResult<{ value: GraphTrending[] }>> {
    const parameters: { $filter?: string, extractSensitivityLabel?: string, fetchSensitivityLabelMetadata?: string } = { $filter, extractSensitivityLabel, fetchSensitivityLabelMetadata };
    const result = await getPowerSdkInstance(dataSourcesInfo).Data.executeAsync<{ $filter?: string, extractSensitivityLabel?: string, fetchSensitivityLabelMetadata?: string }, { value: GraphTrending[] }>({
      connectorOperation: {
        tableName: Office365UsersService.dataSourceName,
   ...
   */
  public static async TrendingDocuments(id: string, $filter?: string, extractSensitivityLabel?: string, fetchSensitivityLabelMetadata?: string): Promise<IOperationResult<{ value: GraphTrending[] }>> {
    const parameters: { id: string, $filter?: string, extractSensitivityLabel?: string, fetchSensitivityLabelMetadata?: string } = { id, $filter, extractSensitivityLabel, fetchSensitivityLabelMetadata };
    const result = await getPowerSdkInstance(dataSourcesInfo).Data.executeAsync<{ id: string, $filter?: string, extractSensitivityLabel?: string, fetchSensitivityLabelMetadata?: string }, { value: GraphTrending[] }>({
      connectorOperation: {
        tableName: Office365UsersService.dataSourceName,
